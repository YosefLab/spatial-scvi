...
from scvi.nn import DecoderSCVI, Encoder, LinearDecoderSCVI, one_hot, Decoder
...
class compoVAE(BaseMinifiedModeModuleClass):
    ...
    def __init__(
        ...
        self.cell_type_decoder = Decoder(
            n_input_decoder,
            n_cell_types,
            # n_cat_list=cat_list,
            n_cat_list=None,
    ...
    def loss(
        ...
        # print('CE: ', ct_classif_loss)
        # print(loss.shape, ct_classif_loss.shape, kl_divergence_l.shape, kl_divergence_z.shape, reconst_loss.shape)
